# -*- coding: utf-8 -*-
"""Build menuch-pricing.html from manooch-pricing-structure-v2.md"""
import base64
...
# ---------------- modules (sections 2.1, 4-19) ----------------
# badge types: ('price', '۲۹۰٬۰۰۰'), ('tbd', None), ('core', 'افزونه نیست')
MODULES = [
    dict(title="ظرفیت‌ها و محدودیت‌ها", badge=("core", "افزونه نیست"),
         ...
         rows=[("تعداد محصول فعال", "۱۰۰", "۱٬۰۰۰", "نامحدود"),
               ...
               ("ویس محصول", "❌", "✅", "✅")]),
    dict(title="انواع محصول / سرویس", badge=("core", "هسته محصول"),
         note="افزودن محصولات ارزی فقط در پلن پرو فعال است و در وضعیت فعلی افزونه مستقل نیست.",
         rows=[("افزودن کالا", "✅", "✅", "✅"),
               ("افزودن خدمات", "✅", "✅", "✅"),
               ("افزودن محصولات ارزی", "❌", "❌", "✅")]),
    dict(title="فروشگاه و کاتالوگ", badge=("core", "در همه پلن‌ها"),
         note="در ساختار فعلی چیزی به نام «زیردسته‌بندی» نداریم.",
    ...
    dict(title="ویژگی محصول", badge=("core", "افزونه نیست"),
         note="ویژگی بخشی از هسته محصول است و در پلن پایه هم وجود دارد.",
         rows=[("ویژگی محصول", "✅", "✅", "✅"),
               ("رنگ", "✅", "✅", "✅"),
               ("سایز", "✅", "✅", "✅"),
               ("مشخصات", "✅", "✅", "✅"),
    ...
    dict(title="واحد فروش پیشرفته", badge=("price", "۲۹۰٬۰۰۰"),
         note="با «ویژگی» متفاوت است و یک فیچر ساختاری مستقل محسوب می‌شود.",
    ...
    dict(title="انبار", badge=("tbd", None),
         note="Excel افزونه مستقل نیست و کاملاً زیرمجموعه انبار قرار می‌گیرد.",
         rows=[("انبار", "❌", "✅", "✅"),
               ("مدیریت موجودی", "❌", "✅", "✅"),
               ("هشدار کمبود موجودی", "❌", "✅", "✅"),
               ("موجودی نامحدود کالا", "❌", "✅", "✅"),
    ...
    dict(title="نوع پرداخت", badge=("core", "در پلن‌ها"),
         note="پرداخت آنلاین شامل زرین‌پال، زیبال، درگاه‌های بانکی و سایر Gatewayهاست؛ Providerها قیمت مستقل ندارند.",
         rows=[("پرداخت آنلاین", "✅", "✅", "✅"),
               ("پرداخت در محل", "✅", "✅", "✅"),
    ...
    dict(title="فروش اقساطی", badge=("price", "۳۹۰٬۰۰۰"),
         note="با فعال‌شدن آن، Providerهای پشتیبانی‌شده زیر آن قرار می‌گیرند.",
         rows=[("فروش اقساطی", "❌", "❌", "✅"),
               ("اسنپ‌پی", "❌", "❌", "✅"),
               ("ترب‌پی", "❌", "❌", "✅"),
               ("دیجی‌پی", "❌", "❌", "✅"),
    ...
    dict(title="مشتریان", badge=("core", "در همه پلن‌ها"),
         ...
         rows=[("دفترچه مشتریان", "✅", "✅", "✅"),
               ...
               ("تاریخچه خرید", "✅", "✅", "✅"),
               ("جستجوی مشتری", "✅", "✅", "✅")]),
    dict(title="محتوا", badge=("tbd", None),
         note="Notification زیرمجموعه محتواست و جداگانه قیمت‌گذاری نمی‌شود.",
         rows=[("محتوا", "❌", "✅", "✅"),
               ("Banner", "❌", "✅", "✅"),
               ("Gallery", "❌", "✅", "✅"),
               ("FAQ", "❌", "✅", "✅"),
    ...
    dict(title="نظرات", badge=("price", "۷۹٬۰۰۰"),
         note="باید مشخص شود که نظرات ماژول فروشی مستقل باشد یا فقط داخل Bundle پلن‌ها.",
         rows=[("نظرات", "❌", "✅", "✅"),
               ("امتیازدهی", "❌", "✅", "✅"),
               ("ثبت نظر", "❌", "✅", "✅"),
               ("تأیید / رد نظر", "❌", "✅", "✅")]),
    ...
    dict(title="باشگاه مشتریان", badge=("price", "۶۹۰٬۰۰۰"),
         note="در هر دو حالت (پرو یا خرید جداگانه) تمام قابلیت‌ها فعال می‌شود؛ اعتبار SMS بر اساس مصرف محاسبه می‌شود.",
         rows=[("باشگاه مشتریان", "❌", "❌", "✅"),
               ("امتیاز خوش‌آمدگویی", "❌", "❌", "✅"),
               ("امتیاز بر اساس خرید", "❌", "❌", "✅"),
               ("مصرف امتیاز", "❌", "❌", "✅"),
...
def gchip_html(kind, val):
    ...
    if kind == "tbd":
        return '<span class="gchip tbd">قیمت: نیاز به تصمیم نهایی</span>'
...
def price_cell(kind, val, idx):
    ...
    if idx == 0:
        ...
        return '<span class="chip tbd">نیاز به تصمیم</span>'
...
for name, price, tbd in PLUGINS:
    if tbd:
        p = '<span class="chip tbd">نیاز به تصمیم نهایی</span>'
    else:
...
DECISIONS = [
    ...
    "قیمت مستقل ماژول محتوا",
    "اینکه «نظرات» واقعاً افزونه مستقل باشد یا فقط داخل پلن‌ها قرار بگیرد",
    "اینکه تخفیف به‌صورت افزونه مستقل فروخته شود یا داخل Bundle استاندارد قرار بگیرد",
    "سیاست تخفیف برای پرداخت سه‌ماهه، شش‌ماهه و سالانه",
    "هزینه و Margin پیامک",
    "هزینه Storage",
    "هزینه نگهداری Integrationها",
    "بررسی اقتصادی بودن Bundle استاندارد و پرو در برابر خرید چند افزونه مستقل",
]
...
<title>تعرفه‌های منوچ — ساختار پلن‌ها و افزونه‌ها</title>
<style>
{FONT_CSS}
:root{{
...
.chip.tbd{{display:inline-block;font-size:11.5px;font-weight:700;padding:5px 12px;border-radius:999px;
...
<section class="wrap sec">
  ...
  <div class="plug-grid">
    <div class="tbl">
      <table class="plug">
        <thead><tr><th class="feat">افزونه ساختاری</th><th>قیمت ماهانه پیشنهادی</th></tr></thead>
        <tbody>
{PLUG_TBODY}
        </tbody>
      </table>
    ...
    <div>
      <div class="tbl">
        <table class="plug">
          <tbody>
            <tr><td class="feat">مشتری کوچک</td><td class="pl muted" style="color:var(--mut);font-size:12.5px">با پلن پایه شروع می‌کند</td></tr>
            <tr><td class="feat">مشتری با یک نیاز خاص</td><td class="pl muted" style="color:var(--mut);font-size:12.5px">همان ماژول را جدا می‌خرد</td></tr>
            <tr><td class="feat">مشتری با چند نیاز حرفه‌ای</td><td class="pl muted" style="color:var(--mut);font-size:12.5px">به استاندارد یا پرو ارتقا می‌دهد</td></tr>
            <tr><td class="feat">Providerها و Integrationها</td><td class="pl muted" style="color:var(--mut);font-size:12.5px">جداگانه فروخته نمی‌شوند</td></tr>
          </tbody>
        </table>
      </div>
      <p class="note">مشتری Capability را می‌خرد، نه Connector را؛ پیچیدگی داخلی محصول از صفحه قیمت‌گذاری پنهان می‌ماند.</p>
    </div>
  </div>
</section>
...
<section class="wrap sec">
  <div class="sec-head">
    <h2>مواردی که هنوز نیاز به تصمیم دارند</h2>
    <p>موارد زیر در R&amp;D نهایی نشده‌اند.</p>
  </div>
  <ol class="dec">
    {decisions}
  </ol>
...
<footer class="wrap foot">
  ساختار نهایی: <b>اشتراک ماهانه + افزونه‌های ساختاری</b> — خروجی جلسات R&amp;D قیمت‌گذاری منوچ
</footer>
